            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                    <label for="leftTaskSelector1">1st predecessor</label>
                            ...
                            <div class="col-md-6 form-group">
                                    <label for="leftTaskSelector2">2nd predecessor</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                    <label for="rightTaskSelector1">1st successor</label>
                            ...
                            <div class="col-md-6 form-group">
                                    <label for="rightTaskSelector2">2nd successor</label>
