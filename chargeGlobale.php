...
<div class="row">
  <button id="titreChargeGlobale" class="btn btn-primary btn-block" type="button">
    Charge globale
  </button>
</div>
<div id="contenuChargeGlobale" class="contenu">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <!-- <form methode ="POST" action ="traitement.php"> -->
        <button class="btn btn-primary btn-block" type="submit" onclick="calculate(typeSimulateur.value, iteration.value, intervalle.value, probabiliteGivenProbability.value, chargeGivenCharge.value, 'containerChargeGlobale')">
          Générer graphique
        </button>
      <!-- </form> -->
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <!-- <form methode ="POST" action ="traitement.php"> -->
        <button class="btn btn-primary btn-block" type="submit" onclick="estimateProbability(typeSimulateur.value, iteration.value, intervalle.value, probabiliteGivenProbability.value, chargeGivenCharge.value)">
          Calculer
        </button>
      <!-- </form> -->
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <button class="btn btn-primary btn-block" type="submit" onclick="estimateCharge(typeSimulateur.value, iteration.value, intervalle.value, probabiliteGivenProbability.value, chargeGivenCharge.value)">
        Calculer
      </button>
    </div>
    <div class="col-md-4">
